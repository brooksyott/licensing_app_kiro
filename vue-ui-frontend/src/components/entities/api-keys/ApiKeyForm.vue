...
import type { ApiKey, CreateApiKeyDto, UpdateApiKeyDto } from '@/types/apiKey'
...
interface Emits {
  (e: 'submit', data: CreateApiKeyDto | UpdateApiKeyDto): void
  (e: 'cancel'): void
}
...
const validateForm = (): boolean => {
  let isValid = true
  errors.value = { name: '', role: '', createdBy: '' }
  ...
  if (props.mode === 'create' && !formData.value.createdBy.trim()) {
...
<template>
  <div class="form-overlay" @click.self="handleCancel">
    <div class="form-modal">
      <h3>{{ mode === 'create' ? 'Create API Key' : 'Edit API Key' }}</h3>
      <form @submit.prevent="handleSubmit">
        ...
        <div v-if="mode === 'edit'" class="form-group checkbox-group">
          <label>
